...
def verify_input_validation():
    ...
    try:
        ...
        days = InputValidator.validate_numeric(
            30,
            min_value=1,
            max_value=365
        )
...
def verify_security_config():
    ...
    print(f"✓ Protected file patterns: {', '.join(config.security.sensitive_file_patterns)}")
...
if __name__ == "__main__":
    ...
    print("  pytest -xvs tests/config/test_credentials.py tests/config/test_validation.py")