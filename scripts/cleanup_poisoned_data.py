...
def reset_symbol_cache(data_dir: Path) -> None:
    ...
    if cache_file.exists():
        try:
            ...
            print(f"✅ Reset symbol cache: cleared {original_failed_count} failed symbols")
...
def create_cleanup_summary(backup_dir: Path, backed_up_files: List[str], cache_backed_up: bool) -> None:
