...
class ModelTrainer:
    ...
    def _create_optimizer(self, model: nn.Module, learning_rate: float) -> optim.Optimizer:
    ...
    def _create_training_summary(self) -> Dict[str, Any]:
        ...
        val_accuracies = [m.val_accuracy for m in self.history if m.val_accuracy is not None]
