...
class ModelStorage:
    ...
    def list_models(self, strategy_name: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        search_paths = [self.base_path / strategy_name] if strategy_name else self.base_path.iterdir()
            ...
            for model_dir in strategy_dir.iterdir():
                ...
                if metadata_path.exists():
                    ...
                    models.append({
                        ...
                        "accuracy": metadata.get("training_summary", {}).get("best_val_accuracy", 0)
                    })
    ...
    def delete_model(self, 
        ...
        if model_dir.exists():
            ...
            latest_link = self.base_path / strategy_name / f"{symbol}_{timeframe}_latest"
    ...
    def _create_version_directory(self, 
                                 strategy_name: str,
                                 symbol: str,
                                 timeframe: str) -> Path:
