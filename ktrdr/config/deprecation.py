...
- M5: AGENT_* → KTRDR_AGENT_* (agent settings)
- M5: DATA_* → KTRDR_DATA_* (data settings)
- M5: MODELS_DIR → KTRDR_DATA_MODELS_DIR
- M5: KTRDR_API_URL → KTRDR_API_CLIENT_BASE_URL
"""
