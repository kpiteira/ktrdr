    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            if log_args and (args or kwargs):
                ...
                for i, arg in enumerate(args):
                    if i < len(param_names):
                        name = param_names[i]
                        arg_value = repr(arg) if not isinstance(arg, (int, float, str, bool)) else arg
                ...
                for name, value in kwargs.items():
                    arg_value = repr(value) if not isinstance(value, (int, float, str, bool)) else value
                    arg_strs.append(f"{name}={arg_value}")
            ...
            try:
                ...
                if log_result:
                    result_str = repr(result) if not isinstance(result, (int, float, str, bool)) else result
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                completion_msg = f"Completed {operation} of {data_type} in {elapsed:.3f}s"
                ...
                elapsed = time.time() - start_time
                log.error(f"Failed {operation} of {data_type} after {elapsed:.3f}s: {e}")
