...
class ColumnStandardizer:
    ...
    def standardize_indicator_name(
        ...
        if parameters:
            ...
            for key, value in sorted(parameters.items()):
                if key in ['period', 'fast_period', 'slow_period', 'signal_period', 'window']:
    ...
    def _infer_column_type(self, column_name: str) -> ColumnType:
        ...
        fuzzy_patterns = [
            r'oversold', r'overbought', r'neutral', r'bullish', r'bearish',
            r'strong', r'weak', r'high', r'low', r'medium'
        ]
        ...
        signal_patterns = [
            r'signal', r'buy', r'sell', r'hold', r'confidence', r'probability'
        ]
        ...
        indicator_patterns = [
            r'rsi', r'sma', r'ema', r'macd', r'bb', r'atr', r'adx',
            r'stoch', r'williams', r'cci', r'mfi', r'obv', r'momentum'
        ]
        ...
        for pattern in patterns:
            ...
            if match:
                ...
                for i, group in enumerate(groups[1:], 1):
                    if group.isdigit():
                        param_names = ['period', 'fast_period', 'slow_period', 'signal_period']
            ...
            for col in columns:
                if col not in self.column_mapping:
                    if not any(col.endswith(f"_{t}") for t in timeframes):
                        if col.lower() not in self.OHLCV_COLUMNS and col.lower() not in self.TIMESTAMP_COLUMNS:
                            results["warnings"].append(f"Column '{col}' may need timeframe suffix")
