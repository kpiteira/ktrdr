...
class IndicatorParameter(BaseModel):
    ...
    options: Optional[List[Any]] = Field(None, description="Available options for enum-like parameters")
...
class IndicatorMetadata(BaseModel):
    ...
    parameters: List[IndicatorParameter] = Field(..., description="Available parameters")
    resources: Optional[Dict[str, str]] = Field(None, description="Additional resources (URLs, docs)")
...
class IndicatorConfig(BaseModel):
    ...
    output_name: Optional[str] = Field(None, description="Custom name for the indicator output")
...
class IndicatorResult(BaseModel):
    ...
    values: List[Optional[float]] = Field(..., description="Calculated indicator values")
...
class IndicatorCalculateRequest(BaseModel):
    ...
    indicators: List[IndicatorConfig] = Field(..., description="Indicator configurations to calculate")
    start_date: Optional[str] = Field(None, description="Start date for calculation (ISO format)")
    end_date: Optional[str] = Field(None, description="End date for calculation (ISO format)")
...
class IndicatorCalculateResponse(BaseModel):
    ...
    indicators: Dict[str, List[Optional[float]]] = Field(..., description="Calculated indicator values")
    metadata: Optional[Dict[str, Any]] = Field(None, description="Additional metadata")
...
class IndicatorDetail(BaseModel):
    ...
    description_html: Optional[str] = Field(None, description="HTML-formatted description")
    formula_html: Optional[str] = Field(None, description="HTML-formatted formula")
    examples: Optional[List[Dict[str, Any]]] = Field(None, description="Example configurations and results")
