...
class DataErrorDetail(BaseModel):
    ...
    timeframe: Optional[str] = Field(
        None, description="The timeframe that caused the error"
    )
...
class IndicatorErrorDetail(BaseModel):
    ...
    indicator_id: Optional[str] = Field(
        None, description="The indicator ID that caused the error"
    )
...
class FuzzyErrorDetail(BaseModel):
    ...
    config_id: Optional[str] = Field(
        None, description="The fuzzy config ID that caused the error"
    )
    variable: Optional[str] = Field(
        None, description="The variable that caused the error"
    )
    message: str = Field(..., description="Error message")
...
class DetailedErrorResponse(ErrorResponse):
    ...
    request_id: Optional[str] = Field(
        None, description="Unique request ID for tracking"
    )
    documentation_url: Optional[str] = Field(
        None, description="URL to error documentation"
    )
    validation_errors: Optional[ValidationErrorDetail] = Field(
