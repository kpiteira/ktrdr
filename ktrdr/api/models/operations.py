...
class OperationProgress(BaseModel):
    ...
    percentage: float = Field(0.0, ge=0.0, le=100.0, description="Progress percentage (0-100)")
    ...
    items_total: Optional[int] = Field(None, ge=0, description="Total number of items to process")
...
class OperationInfo(BaseModel):
    ...
    progress: OperationProgress = Field(default_factory=OperationProgress, description="Progress information")
    metadata: OperationMetadata = Field(default_factory=OperationMetadata, description="Operation metadata")
...
class CancelOperationRequest(BaseModel):
    ...
    force: bool = Field(False, description="Force cancellation even if operation is in critical section")
