...
class IBDiagnosis:
    ...
    @staticmethod
    async def _test_tcp_connection(host: str, port: int, timeout: float = 5.0) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            return (False, {
                "error": str(e),
                "suggestion": "Network or configuration issue"
            })
