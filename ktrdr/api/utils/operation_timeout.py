...
def with_global_timeout(timeout_seconds: float = 30.0, operation_name: str = "IB Operation"):
    """
    ...
    def decorator(func: F) -> F:
        ...
        async def wrapper(*args, **kwargs):
            ...
            logger.debug(f"🕐 Starting {operation_name} with {timeout_seconds}s global timeout")
...
class OperationTimeoutError(Exception):
    ...
    def __init__(self, operation_name: str, timeout_seconds: float, actual_duration: float):
