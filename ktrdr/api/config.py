...
class APIConfig(BaseModel):
    ...
    # API metadata
    title: str = Field(
        default="KTRDR API", description="API title displayed in documentation"
    )
    ...
    reload: bool = Field(
        default=True, description="Enable/disable auto-reload for development"
    )
    log_level: str = Field(
    ...
    api_prefix: str = Field(
        default="/api/v1", description="API version prefix for all endpoints"
    )
