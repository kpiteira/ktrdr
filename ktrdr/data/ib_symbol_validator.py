...
class IbSymbolValidator:
        ...
        for asset_type, contract_creator in contract_types:
            try:
                ...
                if contract_info:
                    ...
                    logger.info(f"Validated {normalized} as {asset_type}: {contract_info.description}")
    ...
    def batch_get_contracts(self, symbols: List[str]) -> Dict[str, Optional[ContractInfo]]:
        """
