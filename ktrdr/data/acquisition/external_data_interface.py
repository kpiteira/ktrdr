...
class ExternalDataProvider(ABC):
    ...
    async def get_market_hours(
        ...
        """
        logger.debug(
            f"Market hours not implemented for provider {self.__class__.__name__}"
        )
        return None
    ...
    async def get_contract_details(
        ...
        """
        logger.debug(
            f"Contract details not implemented for provider {self.__class__.__name__}"
        )
        return None
    ...
    async def search_symbols(
        ...
        """
        logger.debug(
            f"Symbol search not implemented for provider {self.__class__.__name__}"
        )
        return []
