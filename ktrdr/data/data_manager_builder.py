...
class DataManagerBuilder:
    ...
    REPAIR_METHODS = {
        "ffill", "bfill", "interpolate", "zero", "mean", "median", "drop"
    }
    ...
    def with_ib_configuration(self, config: IbHostServiceConfig) -> "DataManagerBuilder":
    ...
    def _build_ib_adapter(self) -> IbDataAdapter:
        ...
        if self._config.ib_host_service_config is None:
            self._config.ib_host_service_config = IbConfigurationLoader.load_configuration()
    ...
    def _build_core_components(self) -> None:
        ...
        self._config.gap_analyzer = GapAnalyzer(gap_classifier=self._config.gap_classifier)
...
def create_default_datamanager_builder() -> DataManagerBuilder:
    ...
    return (DataManagerBuilder()
            .with_gap_settings(5.0)
            .with_repair_method("ffill"))
