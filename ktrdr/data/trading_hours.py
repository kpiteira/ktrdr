...
class TradingHoursManager:
    ...
    EXCHANGE_HOURS: Dict[str, TradingHours] = {
        ...
        "IDEALPRO": TradingHours(
            timezone="UTC",
            regular_hours=TradingSession(time(22, 0), time(21, 59), "24H"),  # Sunday 22:00 to Friday 22:00 UTC
            extended_hours=[],
        ...
        "HKFE": TradingHours(  # Hong Kong Futures Exchange
            ...
            extended_hours=[
                TradingSession(time(17, 15), time(23, 59), "Evening")
            ],
            trading_days=[0, 1, 2, 3, 4]
        ),
    }
    ...
    @classmethod
    def get_trading_hours(cls, exchange: str, asset_type: str = "STK") -> Optional[TradingHours]:
        """
    ...
    @classmethod
    def is_market_open(cls, timestamp: pd.Timestamp, exchange: str, asset_type: str = "STK", 
    ...
    @classmethod
    def get_market_status(cls, timestamp: pd.Timestamp, exchange: str, 
                         asset_type: str = "STK") -> str:
        """
