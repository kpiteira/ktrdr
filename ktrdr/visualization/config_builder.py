...
class ConfigBuilder:
    ...
    def create_price_chart_options(
        ...
        **kwargs
        ...
        """
        # Get base options
        options = ConfigBuilder.create_chart_options(theme=theme, height=height, **kwargs)
        ...
        **kwargs
        ...
        if series_type == "candlestick":
            ...
            options.update({
                ...
                "lineStyle": kwargs.get("line_style", 0),  # 0 = solid, 1 = dotted, 2 = dashed
                "crosshairMarkerVisible": kwargs.get("crosshair_marker_visible", True),
                "crosshairMarkerRadius": kwargs.get("crosshair_marker_radius", 4)
            })
        elif series_type == "area":
            options.update({
                "topColor": kwargs.get("top_color", color + "80"),  # Add alpha for transparency
