...
ERROR_EXAMPLES = [
    {
        ...
        "request_example": {
            ...
            "indicators": [{"id": "RSIIndicator", "parameters": {"period": 14}}],
        },
        "response_example": {
            "detail": {
                "loc": ["body", "timeframe"],
    ...
    },
    {
        ...
        "request_example": {
            ...
            "timeframe": "1d",
            "indicators": [
                {"id": "UnknownIndicator", "parameters": {}}  # Unknown indicator
            ],
        },
        "response_example": {
            "success": False,
            "error": {
                ...
                "details": {"indicator_id": "UnknownIndicator"},
            },
        },
        "status_code": 400,
    },
...
if __name__ == "__main__":
    ...
    print("```json")
    print(
        json.dumps(CALCULATE_MULTIPLE_INDICATORS_EXAMPLE["request_example"], indent=2)
    )
    print("```\n")
    print("**Response:**")
    print("```json")
    print(
        json.dumps(CALCULATE_MULTIPLE_INDICATORS_EXAMPLE["response_example"], indent=2)
    )
    print("```\n")
