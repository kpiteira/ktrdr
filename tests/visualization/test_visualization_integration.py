...
from ktrdr.visualization import Visualizer, DataAdapter, ConfigBuilder, TemplateManager, Renderer
...
class TestVisualizationIntegration:
    ...
    def test_chart_with_multiple_overlays(self, sample_price_data, sample_indicators, tmp_path):
        ...
        for i, col in enumerate(['bollinger_upper', 'bollinger_middle', 'bollinger_lower']):
            chart = visualizer.add_indicator_overlay(
                chart=chart,
                data=sample_indicators,
                column=col,
