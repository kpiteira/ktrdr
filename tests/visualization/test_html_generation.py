...
class TestHtmlGeneration:
    ...
    def test_render_chart_with_indicators(self, renderer, sample_indicator_chart_configs, sample_chart_data):
    ...
    def test_render_chart_theme_switch(self, renderer, sample_chart_configs, sample_chart_data):
    ...
    def test_render_chart_with_range_slider(self, renderer, sample_chart_configs, sample_chart_data):
    ...
    def test_html_structure_validity(self, renderer, sample_chart_configs, sample_chart_data):
    ...
    def test_invalid_theme_handling(self, renderer, sample_chart_configs, sample_chart_data):
    ...
    def test_save_chart_functionality(self, renderer, sample_chart_configs, sample_chart_data, tmp_path):
    ...
    def test_update_theme(self, renderer):
        ...
        light_html = renderer.update_theme(
        ...
        dark_html = renderer.update_theme(
            html_content=light_html,
            theme="dark"
        )
    ...
    def test_chart_generation_cross_browser_compatibility(self, renderer, sample_chart_configs, sample_chart_data):
