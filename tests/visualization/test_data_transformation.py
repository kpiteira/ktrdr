...
class TestDataTransformation:
    ...
    def test_line_transformation(self, sample_indicators):
        ...
        result = DataAdapter.transform_line(
            sample_indicators, time_column="date", value_column="sma_10"
        )
        ...
        for i, row in enumerate(sample_indicators.iterrows()):
            ...
            if pd.notna(source_val):
                ...
                matching_items = [
                    ...
                    for r in result
                    if "value" in r
                    and pytest.approx(r["value"], rel=1e-5) == source_val
                ]
    ...
    def test_histogram_transformation(self, histogram_data):
        ...
        result = DataAdapter.transform_histogram(
            histogram_data, time_column="date", value_column="value"
        )
    ...
    def test_transform_with_edge_cases(self, edge_case_data):
        ...
        result = DataAdapter.transform_line(
            edge_case_data, time_column="date", value_column="missing_values"
        )
        ...
        result = DataAdapter.transform_line(
            edge_case_data, time_column="date", value_column="extreme_values"
        )
        ...
        result = DataAdapter.transform_line(
            edge_case_data, time_column="date", value_column="constant"
        )
    ...
    def test_serializable_output(
        self, sample_price_data, sample_indicators, histogram_data
    ):
