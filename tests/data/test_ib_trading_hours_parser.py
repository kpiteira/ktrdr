...
class TestIBTradingHoursParser(unittest.TestCase):
    ...
    def test_map_timezone(self):
        ...
        # Known mappings
        self.assertEqual(IBTradingHoursParser._map_timezone("US/Eastern"), "America/New_York")
        self.assertEqual(IBTradingHoursParser._map_timezone("UTC"), "UTC")
        self.assertEqual(IBTradingHoursParser._map_timezone("Europe/London"), "Europe/London")
        
        # Unknown timezone (should return as-is)
        self.assertEqual(IBTradingHoursParser._map_timezone("Unknown/Timezone"), "Unknown/Timezone")
    ...
    def test_extract_extended_hours(self):
        ...
        extended = IBTradingHoursParser._extract_extended_hours(all_sessions, regular_sessions)
    ...
    def test_create_from_contract_details(self):
        ...
        trading_hours = IBTradingHoursParser.create_from_contract_details(contract_details)
