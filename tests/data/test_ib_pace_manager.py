...
class TestIbPaceManager:
    ...
    def mock_error_handler(self):
        ...
        handler.classify_error = Mock(return_value=IbErrorInfo(
            error_code=162,
    ...
    def test_request_key_creation(self, pace_manager):
        ...
        key2 = pace_manager._create_request_key("MSFT", "1d", "backfill", start_date, end_date)
    ...
    def test_pace_limits_calculation(self, pace_manager):
        ...
        wait_time = pace_manager._calculate_required_wait_sync("test_key", "test_component")
        ...
        wait_time = pace_manager._calculate_required_wait_sync("new_key", "test_component")
        assert wait_time > 0.0
    ...
    def test_identical_request_limit(self, pace_manager):
        ...
        wait_time = pace_manager._check_identical_request_limit(request_key, time.time())
        assert wait_time == 0.0
...
class TestErrorHandlerIntegration:
    ...
    def test_error_classification_integration(self, pace_manager_with_real_handler):
        ...
        test_cases = [
            (162, "Historical data request pacing violation", IbErrorType.PACING_VIOLATION),
...
class TestPerformanceAndStress:
    ...
    def test_large_request_history_performance(self, stress_pace_manager):
        ...
        start_time = time.time()
        wait_time = manager._calculate_required_wait_sync("new_request", "test_component")
        elapsed = time.time() - start_time
