...
class TestExternalDataInterface(unittest.TestCase):
    ...
    async def test_optional_methods_default_behavior(self):
        ...
        market_hours = await provider.get_market_hours("AAPL", datetime.now(timezone.utc))
...
class TestDataProviderExceptions(unittest.TestCase):
    ...
    def test_connection_error(self):
        ...
        error = DataProviderConnectionError("Connection failed", "TestProvider", "CONN001")
    ...
    def test_rate_limit_error(self):
        ...
        error = DataProviderRateLimitError("Rate limit exceeded", "TestProvider", retry_after=60.0)
    ...
    def test_config_error(self):
        ...
        error = DataProviderConfigError("Invalid configuration", "TestProvider", "CONFIG001")
