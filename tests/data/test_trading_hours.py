...
class TestTradingHours(unittest.TestCase):
    ...
    def test_get_trading_hours_forex(self):
        ...
        self.assertEqual(
            hours.trading_days, [0, 1, 2, 3, 4, 6]
    ...
    def test_is_market_open_extended_hours(self):
        ...
        is_open_regular = TradingHoursManager.is_market_open(
            timestamp, "NASDAQ", "STK", include_extended=False
        )
        self.assertFalse(is_open_regular)

        # Should be open for extended hours
        is_open_extended = TradingHoursManager.is_market_open(
            timestamp, "NASDAQ", "STK", include_extended=True
        )
