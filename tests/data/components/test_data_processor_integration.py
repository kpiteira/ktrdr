...
class TestDataProcessorIntegration:
    ...
    def test_validation_uses_data_processor(self, data_manager):
        ...
        with patch.object(data_manager, '_load_with_fallback') as mock_load:
            ...
            }, index=pd.date_range('2023-01-01 09:30:00', periods=3, freq='1h', tz='UTC'))
    ...
    def test_processor_error_handling_integration(self, data_manager):
        ...
        with patch.object(data_manager, '_load_with_fallback') as mock_load:
            ...
            invalid_data = pd.DataFrame({
                ...
                'close': [102, 106],
                'volume': [1000, 1500]
            }, index=pd.date_range('2023-01-01 09:30:00', periods=2, freq='1h', tz='UTC'))
    ...
    def test_processor_initialization_called_correctly(self, mock_processor_class, data_manager):
    ...
    def test_processing_pipeline_integration(self, data_manager):
        ...
        dates = pd.date_range('2023-01-01 09:30:00', periods=5, freq='1h')  # Naive timestamps
