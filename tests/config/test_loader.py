...
from ktrdr.errors import ConfigurationError, ConfigurationFileError, InvalidConfigurationError
...
class TestConfigLoader:
    ...
    def test_load_valid_yaml(self):
        ...
        try:
            ...
            assert "data" in config.data.directory  # Path is converted to absolute by validator
    ...
    def test_load_invalid_yaml(self):
        ...
        try:
            ...
            assert "validation failed" in str(excinfo.value).lower() or "yaml" in str(excinfo.value).lower()
        finally:
    ...
    def test_load_from_env_with_default(self):
        ...
        try:
            ...
            with patch.dict(os.environ, {}, clear=True):
                config_loader = ConfigLoader()
                config = config_loader.load_from_env("KTRDR_CONFIG", default_path=tmp_path)
