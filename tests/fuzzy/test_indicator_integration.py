...
class TestMultiTimeframeFuzzyIndicatorPipeline:
    ...
    def test_pipeline_initialization(self, sample_indicator_config, sample_fuzzy_config):
    ...
    def test_process_market_data_success(self, mock_fuzzy_engine, mock_indicator_engine, 
                                       sample_indicator_config, sample_fuzzy_config, sample_market_data):
    ...
    @patch('ktrdr.fuzzy.indicator_integration.MultiTimeframeIndicatorEngine')
    @patch('ktrdr.fuzzy.indicator_integration.MultiTimeframeFuzzyEngine')
    def test_process_market_data_indicator_failure(self, mock_fuzzy_engine, mock_indicator_engine,
                                                 sample_indicator_config, sample_fuzzy_config, sample_market_data):
        ...
        mock_indicator_engine.return_value = mock_indicator_instance
        mock_indicator_instance.get_supported_timeframes.return_value = ["1h", "4h"]
        mock_indicator_instance.apply_multi_timeframe.side_effect = Exception("Indicator processing failed")
    ...
    @patch('ktrdr.fuzzy.indicator_integration.MultiTimeframeIndicatorEngine')
    @patch('ktrdr.fuzzy.indicator_integration.MultiTimeframeFuzzyEngine')
    def test_process_market_data_fail_fast(self, mock_fuzzy_engine, mock_indicator_engine,
                                         sample_indicator_config, sample_fuzzy_config, sample_market_data):
    ...
    def test_convert_indicators_to_fuzzy_input(self, sample_indicator_config, sample_fuzzy_config):
    ...
    def test_extract_base_indicator_name(self, sample_indicator_config, sample_fuzzy_config):
    ...
    def test_get_supported_timeframes(self, sample_indicator_config, sample_fuzzy_config):
