...
class TestFuzzyEdgeCases:
    ...
    def edge_case_fuzzy_config(self):
        ...
        config_dict = {
            ...
            "extreme_values": {
                # Extreme range
                "very_wide": {"type": "triangular", "parameters": [-1000.0, 0.0, 1000.0]}
            }
        }
        return FuzzyConfig.model_validate(config_dict)
    ...
    def test_exact_boundary_values(self, standard_fuzzy_engine):
        ...
        result_b = standard_fuzzy_engine.fuzzify("rsi", 30.0)  # Peak of low / start of medium
        ...
        result_c = standard_fuzzy_engine.fuzzify("rsi", 50.0)  # End of low / peak of medium / start of high
        ...
        result_d = standard_fuzzy_engine.fuzzify("rsi", 70.0)  # End of medium / peak of high
...
class TestFuzzyPerformance:
    ...
    def test_performance_scalar_operations(self, standard_fuzzy_engine):
        ...
        print(f"Average time per value: {(execution_time * 1000 / total_operations):.6f} ms")
