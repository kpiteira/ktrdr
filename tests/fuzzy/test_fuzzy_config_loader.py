...
class TestFuzzyConfigLoader:
    ...
    def test_integration_with_real_configs(self):
        ...
        loader = FuzzyConfigLoader(config_dir=Path(__file__).parent.parent.parent / "config")
        ...
        try:
            strategy_config = loader.load_with_strategy_override("trend_momentum_strategy")
