...
class FuzzyValidationResult:
    ...
    def __str__(self) -> str:
        ...
        return (f"Fuzzy validation {status} for {self.indicator}.{self.fuzzy_set}: "
...
class TestFuzzyNumericalValidation:
    ...
    def test_rsi_low_membership(self, standard_fuzzy_engine):
        ...
        assert result.passed, f"RSI low membership validation failed: {result.failed_points} points"
    ...
    def test_rsi_medium_membership(self, standard_fuzzy_engine):
        ...
        assert result.passed, f"RSI medium membership validation failed: {result.failed_points} points"
    ...
    def test_rsi_high_membership(self, standard_fuzzy_engine):
        ...
        assert result.passed, f"RSI high membership validation failed: {result.failed_points} points"
    ...
    def test_macd_negative_membership(self, standard_fuzzy_engine):
        ...
        assert result.passed, f"MACD negative membership validation failed: {result.failed_points} points"
    ...
    def test_macd_neutral_membership(self, standard_fuzzy_engine):
        ...
        assert result.passed, f"MACD neutral membership validation failed: {result.failed_points} points"
    ...
    def test_macd_positive_membership(self, standard_fuzzy_engine):
        ...
        assert result.passed, f"MACD positive membership validation failed: {result.failed_points} points"