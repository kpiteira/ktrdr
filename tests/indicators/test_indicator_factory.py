...
class TestIndicatorFactory:
    ...
    def test_initialization(self):
        ...
        config = IndicatorsConfig(indicators=[
    ...
    def test_indicator_custom_names(self):
        ...
        configs = [
            IndicatorConfig(type="RSI", name="CustomRSI", params={"period": 14})
        ]
        factory = IndicatorFactory(configs)
        indicators = factory.build()
    ...
    def test_invalid_indicator_type(self):
        ...
        configs = [
            IndicatorConfig(type="NonExistentIndicator", params={})
        ]
        factory = IndicatorFactory(configs)
    ...
    def test_invalid_parameters(self):
        ...
        configs = [
            IndicatorConfig(type="RSI", params={"period": -5})  # Invalid period
        ]
        factory = IndicatorFactory(configs)
