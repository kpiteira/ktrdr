...
def create_test_data():
    ...
    close_prices = [
        100, 110, 120, 130, 140,  # Linear increase
        150, 150, 150, 150, 150,  # Plateau
        140, 130, 120, 110, 100,  # Linear decrease
        90, 80, 70, 60, 50,       # Continue decrease
        50, 50, 50, 50, 50,       # Plateau
        60, 70, 80, 90, 100       # Linear increase
    ]
...
class TestSimpleMovingAverage:
    ...
    def test_against_reference_values(self):
        ...
        for idx, expected in SMA_5_REF_VALUES.items():
            ...
            assert abs(actual - expected) < TOLERANCE, f"SMA at position {idx}: expected {expected}, got {actual}"
...
class TestExponentialMovingAverage:
    ...
    def test_against_reference_values(self):
        ...
        for idx, expected in EMA_5_REF_VALUES.items():
            ...
            assert abs(actual - expected) < EMA_TOLERANCE, f"EMA at position {idx}: expected {expected}, got {actual}"
