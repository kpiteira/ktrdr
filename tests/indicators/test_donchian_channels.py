...
class TestDonchianChannelsIndicator:
    ...
    def test_donchian_channels_calculation_basic(self):
        ...
        expected_cols = [
            'DC_Upper_5', 'DC_Lower_5', 'DC_Middle_5', 
            'DC_Width_5', 'DC_Position_5'
        ]
    ...
    def test_donchian_channels_position_calculation(self):
        ...
        data = pd.DataFrame({
            ...
            'close': [95, 100, 105, 90, 110, 97, 103, 92, 108, 101],  # Varying close
            'volume': [1000] * 10
        })
    ...
    def test_donchian_channels_signals(self):
        ...
        signal_cols = [
            'DC_Upper_Breakout_5', 'DC_Lower_Breakout_5',
            'DC_Overbought_5', 'DC_Oversold_5',
            'DC_Strong_Uptrend_5', 'DC_Strong_Downtrend_5'
        ]
    ...
    def test_donchian_channels_analysis(self):
        ...
        required_keys = [
            ...
            "current_price", "channel_width", "position_in_channel"
        ]
