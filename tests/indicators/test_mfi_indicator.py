...
class TestMFIIndicator:
    ...
    def test_basic_calculation(self):
        ...
        data = pd.DataFrame({
            ...
            'volume': [100000, 110000, 120000, 130000, 140000, 150000, 160000, 170000, 180000, 190000, 200000, 210000, 220000, 230000, 240000, 250000, 260000]
        })
    ...
    def test_negative_volume_validation(self):
        ...
        data = pd.DataFrame({
            ...
            'volume': [100000 if i != 5 else -110000 for i in range(16)]  # One negative volume
        })
    ...
    def test_nan_values_in_data(self):
        ...
        data = pd.DataFrame({
            'open': [100, np.nan, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115],
            'high': [101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116],
            'low': [99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114],
            'close': [100.5, 101.5, 102.5, 103.5, 104.5, 105.5, 106.5, 107.5, 108.5, 109.5, 110.5, 111.5, 112.5, 113.5, 114.5, 115.5],
            'volume': [100000, 110000, 120000, 130000, 140000, 150000, 160000, 170000, 180000, 190000, 200000, 210000, 220000, 230000, 240000, 250000]
        })
    ...
    def test_mathematical_properties(self):
        ...
        data = pd.DataFrame({
            ...
            'high': [101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116],
            'low': [99, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114],
            'close': [100.7, 101.7, 102.7, 103.7, 104.7, 105.7, 106.7, 107.7, 108.7, 109.7, 110.7, 111.7, 112.7, 113.7, 114.7, 115.7],
            'volume': [100000, 110000, 120000, 130000, 140000, 150000, 160000, 170000, 180000, 190000, 200000, 210000, 220000, 230000, 240000, 250000]
        })
    ...
    def test_typical_price_calculation(self):
        ...
        data = pd.DataFrame({
            ...
            'close': [101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116],
            'volume': [100000] * 16
        })
