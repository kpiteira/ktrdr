...
class TestATRIndicator:
    ...
    def test_atr_basic_computation(self):
        ...
        data = pd.DataFrame({
            'high': [102, 104, 108, 106, 110, 109, 115, 112, 118, 120, 125, 122, 130, 128, 135],
            'low': [100, 101, 105, 103, 107, 106, 112, 109, 115, 117, 122, 119, 127, 125, 132],
            'close': [101, 103, 107, 104, 109, 108, 114, 111, 117, 119, 124, 121, 129, 127, 134],
        })
    ...
    def test_atr_with_gaps(self):
        ...
        data = pd.DataFrame({
            'high': [102, 104, 130, 132, 105, 107, 109, 111, 113, 115, 117, 119, 121, 123, 125],
            'low': [100, 102, 128, 130, 103, 105, 107, 109, 111, 113, 115, 117, 119, 121, 123],
            'close': [101, 103, 129, 131, 104, 106, 108, 110, 112, 114, 116, 118, 120, 122, 124],
        })
    ...
    def test_atr_with_extreme_volatility(self):
        ...
        data = pd.DataFrame({
            'high': [100, 150, 80, 200, 50, 180, 70, 160, 90, 140, 110, 130, 120, 125, 122],
            'low': [95, 140, 70, 190, 40, 170, 60, 150, 80, 130, 100, 120, 110, 115, 112],
            'close': [98, 145, 75, 195, 45, 175, 65, 155, 85, 135, 105, 125, 115, 120, 117],
        })
