...
class TestVisualizer:
    ...
    def test_add_indicator_panel(self, sample_df):
        ...
        chart = viz.add_indicator_panel(
            chart, sample_df, "indicator2", panel_type="histogram"
        )
        ...
        with pytest.raises(ConfigurationError):
            viz.add_indicator_panel(
                chart, sample_df, "indicator1", panel_type="invalid"
            )
    ...
    def test_save(self, mock_save_chart, mock_render_chart, sample_df):
        ...
        mock_save_chart.assert_called_once_with(
            "<html>Mock Chart</html>", "test.html", False
        )
