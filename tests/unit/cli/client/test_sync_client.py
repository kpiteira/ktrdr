...
class TestSyncCLIClientContextManager:
    """Tests for context manager lifecycle."""

    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_enter_creates_client(self, mock_client_class, mock_resolve):
        """__enter__ creates httpx.Client instance."""
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_exit_closes_client(self, mock_client_class, mock_resolve):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_client_is_none_after_exit(self, mock_client_class, mock_resolve):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_uses_config_timeout(self, mock_client_class, mock_resolve):
        """Client is created with configured timeout."""
        mock_resolve.return_value = "http://localhost:8000/api/v1"
        mock_client = MagicMock()
        mock_client_class.return_value = mock_client

        with SyncCLIClient(timeout=60.0):
            pass
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_uses_resolved_url(self, mock_client_class, mock_resolve):
...
class TestSyncCLIClientHTTPMethods:
    """Tests for HTTP method dispatch."""

    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_get_calls_correct_method(self, mock_client_class, mock_resolve):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_post_calls_correct_method(self, mock_client_class, mock_resolve):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_delete_calls_correct_method(self, mock_client_class, mock_resolve):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_get_passes_params(self, mock_client_class, mock_resolve):
        ...
        with SyncCLIClient() as client:
            client.get("/test", params={"limit": 10})

        call_kwargs = mock_client.request.call_args.kwargs
        assert call_kwargs["params"] == {"limit": 10}


class TestSyncCLIClientRetryBehavior:
    """Tests for retry behavior."""

    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    @patch("ktrdr.cli.client.sync_client.calculate_backoff")
    @patch("time.sleep")
    def test_retries_on_5xx(
        ...
        with SyncCLIClient(max_retries=3) as client:
            result = client.get("/test")
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_no_retry_on_4xx(self, mock_client_class, mock_resolve):
    ...
    def test_raises_after_max_retries(
        ...
        with SyncCLIClient(max_retries=2) as client:
            with pytest.raises(APIError) as exc_info:
                client.get("/test")
...
class TestSyncCLIClientErrorHandling:
    """Tests for error handling."""

    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_raises_connection_error(self, mock_client_class, mock_resolve):
        ...
        with SyncCLIClient(max_retries=0) as client:
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_raises_timeout_error(self, mock_client_class, mock_resolve):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_raises_api_error_with_status_code(self, mock_client_class, mock_resolve):
...
class TestSyncCLIClientHealthCheck:
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_health_check_returns_false_on_error(self, mock_client_class, mock_resolve):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_health_check_returns_false_on_server_error(
        self, mock_client_class, mock_resolve
    ):
    ...
    @patch("ktrdr.cli.client.sync_client.resolve_url")
    @patch("ktrdr.cli.client.sync_client.httpx.Client")
    def test_health_check_uses_short_timeout(self, mock_client_class, mock_resolve):
...
class TestSyncCLIClientConfiguration:
    ...
    def test_explicit_url_overrides_resolve(self, mock_resolve):
        ...
        SyncCLIClient(base_url="http://explicit:9000/api/v1")
