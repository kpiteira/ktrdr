...
class TestCalculateIndicators:
    ...
    def test_calculate_indicators_single_timeframe(self):
        ...
        indicator_configs = [
            {"indicator": "rsi", "name": "rsi", "period": 14},
            {"indicator": "sma", "name": "sma", "period": 20},
        ]
    ...
    def test_calculate_indicators_multi_timeframe(self):
        ...
        indicator_configs = [{"indicator": "rsi", "name": "rsi", "period": 14}]
    ...
    def test_calculate_indicators_handles_sma_ema_ratios(self):
        ...
        indicator_configs = [{"indicator": "sma", "name": "sma", "period": 5}]
    ...
    def test_calculate_indicators_handles_macd(self):
        ...
        indicator_configs = [
            {"indicator": "macd", "name": "macd", "fast_period": 12, "slow_period": 26}
        ]
