...
class TestIbConnection(unittest.TestCase):
    ...
    def test_get_stats(self):
        ...
        expected_keys = {
            "client_id", "connected", "healthy", "requests_processed",
            "errors_encountered", "last_activity", "seconds_since_activity",
            "idle_timeout", "thread_alive", "ib_connected", "queue_size"
        }
