...
class TestMultiTimeframeFeatureEngineer:
    ...
    def test_advanced_fit_transform(self, sample_features, sample_labels, advanced_config):
    ...
    def test_feature_stats_calculation(self, sample_features, sample_labels, basic_config):
    ...
    def test_timeframe_weights(self, sample_features, sample_labels, basic_config):
        ...
        engineer = MultiTimeframeFeatureEngineer(basic_config)
        result = engineer.fit_transform(sample_features, sample_labels, timeframe_weights)
        
        assert result.transformed_features.shape[0] == 100
        assert len(result.feature_names) == 10 + 8 + 5  # Total features from all timeframes
    
    def test_feature_importance_calculation(self, sample_features, sample_labels, basic_config):
    ...
    def test_analyze_timeframe_contributions(self, sample_features, sample_labels, basic_config):
        """Test timeframe contribution analysis."""
        engineer = MultiTimeframeFeatureEngineer(basic_config)
        engineer.fit_transform(sample_features, sample_labels)
        
        analysis = engineer.analyze_timeframe_contributions(sample_features, sample_labels)
    ...
    def test_transformation_metadata(self, sample_features, sample_labels, advanced_config):
