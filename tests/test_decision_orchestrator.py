...
class TestPositionState:
    ...
    def test_position_state_sell_signal(self):
        ...
        buy_bar = pd.Series({"close": 100.0}, name=pd.Timestamp("2024-01-01 10:00:00"))
        ...
        sell_bar = pd.Series({"close": 105.0}, name=pd.Timestamp("2024-01-01 11:00:00"))
...
class TestDecisionOrchestrator:
    ...
    def test_orchestrator_initialization(self):
        ...
        orchestrator = DecisionOrchestrator(
            strategy_config_path=str(self.strategy_path), mode="backtest"
        )
    ...
    def test_mode_specific_logic(self):
        ...
        orchestrator = DecisionOrchestrator(
            strategy_config_path=str(self.strategy_path), mode="live"
        )
