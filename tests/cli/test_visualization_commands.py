...
class TestPlotCommand:
    ...
    def test_plot_basic_chart(self, mock_datamanager, mock_visualizer, temp_output_dir):
        ...
        result = runner.invoke(
            cli_app,
            ["plot", "MSFT", "--output", str(temp_output_dir / "test_chart.html")],
        )
    ...
    def test_plot_with_indicator_overlay(
        self, mock_datamanager, mock_visualizer, mock_indicator_factory, temp_output_dir
    ):
        ...
        result = runner.invoke(
            ...
            [
                ...
                "20",
                "--output",
                str(temp_output_dir / "test_chart_indicator.html"),
            ],
        )
        ...
        for call in mock_visualizer.return_value.add_indicator_panel.call_args_list:
            ...
            if kwargs.get("column") == "test_indicator":
                ...
                break
        assert (
            not indicator_added_as_panel
        ), "Indicator should be added as overlay, not as panel"

    def test_plot_with_indicator_panel(
        self, mock_datamanager, mock_visualizer, mock_indicator_factory, temp_output_dir
    ):
        ...
        result = runner.invoke(
            ...
            [
                ...
                "--panel",
                "--output",
                str(temp_output_dir / "test_chart_panel.html"),
            ],
        )
    ...
    def test_plot_with_light_theme(
        self, mock_datamanager, mock_visualizer, temp_output_dir
    ):
        ...
        result = runner.invoke(
            ...
            [
                ...
                "light",
                "--output",
                str(temp_output_dir / "test_chart_light.html"),
            ],
        )
    ...
    def test_plot_without_volume(
        ...
        result = runner.invoke(
            ...
            [
                ...
                "--no-volume",
                "--output",
                str(temp_output_dir / "test_chart_no_volume.html"),
            ],
        )
    ...
    def test_plot_without_range_slider(
        self, mock_datamanager, mock_visualizer, temp_output_dir
    ):
        ...
        result = runner.invoke(
            ...
            [
                ...
                "--no-range-slider",
                "--output",
                str(temp_output_dir / "test_chart_no_slider.html"),
            ],
        )
...
class TestPlotIndicatorsCommand:
    ...
    def test_plot_indicators_basic(
        self, mock_datamanager, mock_visualizer, mock_indicator_factory, temp_output_dir
    ):
        ...
        result = runner.invoke(
            ...
            [
                ...
                "MSFT",
                "--output",
                str(temp_output_dir / "test_multi_indicator.html"),
            ],
        )
    ...
    def test_plot_indicators_with_overlays(
        self, mock_datamanager, mock_visualizer, mock_indicator_factory, temp_output_dir
    ):
        ...
        result = runner.invoke(
            ...
            [
                ...
                "--overlays",
                "--output",
                str(temp_output_dir / "test_multi_overlays.html"),
            ],
        )
    ...
    def test_plot_indicators_with_light_theme(
        self, mock_datamanager, mock_visualizer, mock_indicator_factory, temp_output_dir
    ):
        ...
        result = runner.invoke(
            ...
            [
                ...
                "light",
                "--output",
                str(temp_output_dir / "test_multi_light.html"),
            ],
        )
...
class TestErrorHandling:
    ...
    def test_plot_invalid_chart_type(self, mock_datamanager):
        ...
        result = runner.invoke(
            cli_app, ["plot", "MSFT", "--chart-type", "invalid_type"]
        )
    ...
    def test_plot_invalid_theme(self, mock_datamanager):
        ...
        result = runner.invoke(cli_app, ["plot", "MSFT", "--theme", "invalid_theme"])
    ...
    def test_plot_indicators_invalid_config_file(self, mock_datamanager):
        ...
        result = runner.invoke(
            cli_app, ["plot-indicators", "MSFT", "--config", "nonexistent_file.yaml"]
        )
