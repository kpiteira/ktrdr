...
class TestMultiTimeframeModelStorage:
    ...
    def sample_label_result(self):
        ...
        timeframe_labels = {
            ...
            "4h": pd.Series(np.random.choice([0, 1, 2], size=13), index=dates[::4][:13]),
        ...
        return MultiTimeframeLabelResult(
            ...
            label_distribution={
                "consensus": {"buy_count": 15, "hold_count": 20, "sell_count": 15, "total": 50},
                "timeframes": {
                    "1h": {"buy_count": 18, "hold_count": 16, "sell_count": 16, "total": 50}
                }
            },
            metadata={
                "timeframes": ["1h", "4h", "1d"],
    ...
    def test_load_multi_timeframe_model(
        ...
        assert loaded_data["config"]["timeframe_configs"] == sample_config["timeframe_configs"]
    ...
    def test_list_multi_timeframe_models(
        ...
        # Filter by strategy
        strategy1_models = storage.list_multi_timeframe_models(strategy_name="strategy1")
    ...
    def test_metadata_completeness(
        ...
        required_fields = [
            "strategy_name", "symbol", "timeframes", "version", "created_at",
            "model_type", "performance_summary", "feature_summary", 
            "label_quality", "pytorch_version"
        ]
