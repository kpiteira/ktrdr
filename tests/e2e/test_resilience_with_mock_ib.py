...
class MockIBGateway:
    ...
    def _handle_normal_connection(self, client):
        ...
        try:
            ...
            client.send(b"4\x002\x001\x00Server Version:176\x00TWS Time:20250614 16:30:00 EST\x00\x00")
...
class TestResilienceWithMockIB:
    ...
    def test_silent_connection_detection(self, mock_ib_silent, api_client):
        ...
        if response.status_code == 503:
            ...
            assert not health_data.get("healthy", True), "Should detect unhealthy connection"
    
    def test_client_id_preference_with_conflicts(self, mock_ib_client_conflicts, api_client):
