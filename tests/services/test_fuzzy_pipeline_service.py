...
from ktrdr.errors import ServiceError, ConfigurationError
...
class TestFuzzyPipelineService:
    ...
    @pytest.fixture
    def sample_config_files(self, sample_indicator_config_dict, sample_fuzzy_config_dict):
    ...
    def test_process_symbol_fuzzy_with_dicts(self, mock_create_pipeline, mock_data_manager,
    ...
    def test_process_symbol_fuzzy_with_files(self, mock_data_manager, sample_config_files):
        """Test processing symbol with file configurations."""
        indicator_file, fuzzy_file = sample_config_files
        
        with patch('ktrdr.services.fuzzy_pipeline_service.create_integrated_pipeline') as mock_create:
            # Mock pipeline
            mock_pipeline = Mock()
    ...
    @patch('ktrdr.services.fuzzy_pipeline_service.create_integrated_pipeline')
    def test_process_multiple_symbols(self, mock_create_pipeline, mock_data_manager,
                                    sample_indicator_config_dict, sample_fuzzy_config_dict):
    ...
    @patch('ktrdr.services.fuzzy_pipeline_service.create_integrated_pipeline')
    def test_process_multiple_symbols_with_error(self, mock_create_pipeline, mock_data_manager,
                                               sample_indicator_config_dict, sample_fuzzy_config_dict):
    ...
    def test_create_single_symbol_report(self, mock_data_manager):
        ...
        mock_fuzzy_result = MultiTimeframeFuzzyResult(
            fuzzy_values={"rsi_low_1h": 0.8, "macd_positive_1h": 0.6, "rsi_high_4h": 0.3},
            timeframe_results={
    ...
    def test_pipeline_caching(self, mock_data_manager, sample_indicator_config_dict, sample_fuzzy_config_dict):
    ...
    @patch('ktrdr.services.fuzzy_pipeline_service.create_integrated_pipeline')
    def test_no_market_data_error(self, mock_create_pipeline, mock_data_manager,
                                sample_indicator_config_dict, sample_fuzzy_config_dict):
