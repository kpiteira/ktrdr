...
def test_fuzzify_indicator(client, mock_fuzzy_service):
    ...
    # Create request data
    request_data = {"indicator": "rsi", "values": [30, 45, 60, 75]}
...
def test_fuzzify_indicator_invalid_data(client, mock_fuzzy_service):
    ...
    request_data = {"indicator": "rsi", "values": []}
...
def test_fuzzify_data(client, mock_fuzzy_service):
    ...
    mock_fuzzy_service.fuzzify_data.return_value = {
        ...
        "metadata": {"start_date": dates[-1], "end_date": dates[0], "points": 5},
    }
    ...
    request_data = {
        ...
        "timeframe": "1d",
        "indicators": [
            {"name": "rsi", "source_column": "close", "parameters": {"period": 14}}
        ],
...
def test_fuzzify_data_invalid_indicator(client, mock_fuzzy_service):
    ...
    request_data = {
        "symbol": "AAPL",
        "timeframe": "1d",
        "indicators": [{"name": "invalid_indicator", "source_column": "close"}],
    }
        ...
        "indicators": [
            {
                ...
                "fuzzy_sets": {
                    ...
                    "custom_low": {
                        "type": "triangular",
                        "params": {"a": 10, "b": 30, "c": 50},
                    },
                    "custom_high": {
                        "type": "triangular",
                        "params": {"a": 50, "b": 70, "c": 100},
                    },
                },
            }
        ],
