...
class TestMultiTimeframeDecisionsAPI:
    ...
    def test_make_multi_timeframe_decision_success(
        ...
        with patch('ktrdr.api.endpoints.multi_timeframe_decisions.create_multi_timeframe_decision_orchestrator') as mock_create, \
             patch('ktrdr.api.endpoints.multi_timeframe_decisions.DataManager') as mock_dm:
            
            mock_create.return_value = mock_decision_orchestrator
            
            # Mock data manager
            mock_dm_instance = Mock()
            mock_dm_instance.get_data.side_effect = lambda symbol, timeframe, rows: sample_timeframe_data.get(timeframe)
            ...
            response = client.post("/api/v1/multi-timeframe-decisions/decide", json=request_data)
    ...
    def test_make_multi_timeframe_decision_invalid_timeframe(self, client, temp_strategy_file):
    ...
    def test_make_multi_timeframe_decision_invalid_mode(self, client, temp_strategy_file):
    ...
    def test_check_multi_timeframe_data_status(
        self, 
        client,
        sample_timeframe_data
    ):
        ...
        with patch('ktrdr.api.endpoints.multi_timeframe_decisions.DataManager') as mock_dm:
            # Mock data manager
            mock_dm_instance = Mock()
            mock_dm_instance.get_data.side_effect = lambda symbol, timeframe, rows: sample_timeframe_data.get(timeframe)
            mock_dm.return_value = mock_dm_instance
    ...
    def test_batch_multi_timeframe_decisions(
        ...
        with patch('ktrdr.api.endpoints.multi_timeframe_decisions.create_multi_timeframe_decision_orchestrator') as mock_create, \
            ...
            response = client.post("/api/v1/multi-timeframe-decisions/batch-decisions", json=batch_requests)
    ...
    def test_batch_multi_timeframe_decisions_size_limit(self, client, temp_strategy_file):
    ...
    def test_legacy_multi_timeframe_decision(
        ...
        with patch('ktrdr.api.endpoints.multi_timeframe_decisions.create_multi_timeframe_decision_orchestrator') as mock_create, \
            ...
            response = client.post("/api/v1/multi-timeframe-decisions/legacy/decide", json=request_data)
