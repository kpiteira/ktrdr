...
class TestFuzzyDataEndpoint:
    ...
    def test_get_fuzzy_overlay_data_success(self):
        ...
        mock_service = Mock()
        mock_service.get_fuzzy_overlays = AsyncMock(return_value={
            "symbol": "AAPL",
            "timeframe": "1h",
            "data": {
                "rsi": [
    ...
    def test_get_fuzzy_overlay_data_with_indicators_filter(self, mock_get_service):
        ...
        mock_service.get_fuzzy_overlays = AsyncMock(return_value={
            ...
            "timeframe": "1h",
            "data": {
                "rsi": [{"set": "low", "membership": []}]
            }
        })
        mock_get_service.return_value = mock_service
        
        # Make request with specific indicators
        response = self.client.get("/api/v1/fuzzy/data?symbol=AAPL&timeframe=1h&indicators=rsi&indicators=macd")
