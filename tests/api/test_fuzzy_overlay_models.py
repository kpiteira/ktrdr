...
class TestFuzzyMembershipPoint:
    ...
    def test_membership_point_boundary_values(self):
        ...
        # Test 0.0
        point_zero = FuzzyMembershipPoint(
            timestamp="2023-01-01T09:00:00",
            value=0.0
        )
        ...
        # Test 1.0
        point_one = FuzzyMembershipPoint(
            timestamp="2023-01-01T09:00:00",
            value=1.0
        )
