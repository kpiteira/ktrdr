...
def mock_data_manager():
    ...
    with patch('ktrdr.api.services.data_service.DataManager') as mock:
        ...
        with patch('ktrdr.api.services.data_service.retry_with_backoff', lambda *args, **kwargs: lambda func: func):
            yield mock_instance
...
def test_load_data_other_exception(mock_data_manager):
    ...
    def load_data_without_retry(self, symbol, timeframe, start_date=None, end_date=None, include_metadata=True):
        try:
