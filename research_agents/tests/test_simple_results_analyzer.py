...
class TestBasicResultsAnalyzer:
    ...
    async def test_classify_risk_profile_basic(self):
        ...
        conservative_metrics = PerformanceMetrics(
            total_return=0.08, annualized_return=0.08, volatility=0.05,
            sharpe_ratio=1.6, sortino_ratio=1.8, max_drawdown=-0.02,
            calmar_ratio=4.0, profit_factor=1.3, win_rate=0.65,
            total_trades=100, avg_trade_return=0.0008, var_95=-0.01,
