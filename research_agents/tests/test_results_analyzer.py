...
class TestResultsAnalyzerInitialization:
    ...
    def test_initialization_with_custom_config(self, analyzer_config):
        ...
        total_weight = (analyzer.return_weight + analyzer.risk_weight + 
                       analyzer.consistency_weight + analyzer.efficiency_weight + 
...
class TestPerformanceMetricsCalculation:
    ...
    async def test_calculate_performance_metrics_success(self, results_analyzer, sample_training_results, sample_backtesting_results):
    ...
    async def test_calculate_performance_metrics_with_missing_data(self, results_analyzer):
...
class TestFitnessComponents:
    ...
    async def test_calculate_return_component(self, results_analyzer):
        ...
        good_metrics = PerformanceMetrics(
            total_return=0.15, annualized_return=0.15, volatility=0.1, sharpe_ratio=1.5,
            sortino_ratio=1.8, max_drawdown=-0.05, calmar_ratio=3.0, profit_factor=1.5,
            win_rate=0.6, total_trades=100, avg_trade_return=0.0015, var_95=-0.02,
            skewness=0.1, kurtosis=3.0, trade_frequency=1.0
        )
    ...
    async def test_calculate_risk_component(self, results_analyzer):
        ...
        low_risk_metrics = PerformanceMetrics(
            total_return=0.15, annualized_return=0.15, volatility=0.05, sharpe_ratio=2.0,
            sortino_ratio=2.2, max_drawdown=-0.03, calmar_ratio=5.0, profit_factor=1.5,
            win_rate=0.6, total_trades=100, avg_trade_return=0.0015, var_95=-0.01,
            skewness=0.0, kurtosis=3.0, trade_frequency=1.0
        )
    ...
    async def test_calculate_consistency_component(self, results_analyzer):
        ...
        consistent_metrics = PerformanceMetrics(
            total_return=0.15, annualized_return=0.15, volatility=0.1, sharpe_ratio=1.5,
            sortino_ratio=2.0, max_drawdown=-0.05, calmar_ratio=3.0, profit_factor=2.0,
            win_rate=0.7, total_trades=100, avg_trade_return=0.0015, var_95=-0.02,
            skewness=0.0, kurtosis=3.0, trade_frequency=1.0
        )
        
        consistency_comp = await results_analyzer._calculate_consistency_component(consistent_metrics)
    ...
    async def test_calculate_efficiency_component(self, results_analyzer):
        ...
        efficient_metrics = PerformanceMetrics(
            total_return=0.15, annualized_return=0.15, volatility=0.1, sharpe_ratio=1.5,
            sortino_ratio=1.8, max_drawdown=-0.05, calmar_ratio=3.0, profit_factor=1.5,
            win_rate=0.6, total_trades=100, avg_trade_return=0.002, var_95=-0.02,
            skewness=0.0, kurtosis=3.0, trade_frequency=2.0  # Good frequency
        )
        
        efficiency_comp = await results_analyzer._calculate_efficiency_component(efficient_metrics)
    ...
    async def test_calculate_robustness_component(self, results_analyzer):
        ...
        robust_metrics = PerformanceMetrics(
            ...
            sortino_ratio=1.8, max_drawdown=-0.05, calmar_ratio=3.0, profit_factor=1.5,
            win_rate=0.6, total_trades=100, avg_trade_return=0.0015, var_95=-0.02,
            skewness=0.1, kurtosis=3.2, trade_frequency=1.0
        )
    ...
    async def test_calculate_penalty_component_poor_metrics(self, results_analyzer):
        ...
        poor_metrics = PerformanceMetrics(
            total_return=-0.05, annualized_return=-0.05, volatility=0.4, sharpe_ratio=-0.2,
            sortino_ratio=-0.3, max_drawdown=-0.25, calmar_ratio=-0.2, profit_factor=0.8,
            win_rate=0.3, total_trades=20, avg_trade_return=-0.0025, var_95=-0.08,
            skewness=-1.0, kurtosis=5.0, trade_frequency=0.1
        )
...
class TestFitnessScoreCalculation:
    ...
    async def test_calculate_overall_fitness_excellent(self, results_analyzer):
        ...
        fitness = await results_analyzer._calculate_overall_fitness(excellent_components)
...
class TestRiskProfileClassification:
    ...
    async def test_classify_conservative_profile(self, results_analyzer):
        ...
        conservative_metrics = PerformanceMetrics(
            total_return=0.08, annualized_return=0.08, volatility=0.03, sharpe_ratio=2.0,
            sortino_ratio=2.2, max_drawdown=-0.015, calmar_ratio=5.3, profit_factor=1.3,
            win_rate=0.65, total_trades=100, avg_trade_return=0.0008, var_95=-0.01,
            skewness=0.0, kurtosis=3.0, trade_frequency=1.0
        )
    ...
    async def test_classify_aggressive_profile(self, results_analyzer):
        ...
        aggressive_metrics = PerformanceMetrics(
            total_return=0.25, annualized_return=0.25, volatility=0.25, sharpe_ratio=1.0,
            sortino_ratio=1.2, max_drawdown=-0.15, calmar_ratio=1.7, profit_factor=1.8,
            win_rate=0.55, total_trades=200, avg_trade_return=0.00125, var_95=-0.05,
            skewness=0.5, kurtosis=4.0, trade_frequency=2.0
        )
    ...
    async def test_classify_speculative_profile(self, results_analyzer):
        ...
        speculative_metrics = PerformanceMetrics(
            total_return=0.5, annualized_return=0.5, volatility=0.4, sharpe_ratio=1.25,
            sortino_ratio=1.5, max_drawdown=-0.3, calmar_ratio=1.7, profit_factor=2.5,
            win_rate=0.5, total_trades=300, avg_trade_return=0.00167, var_95=-0.08,
            skewness=1.0, kurtosis=5.0, trade_frequency=3.0
        )
...
class TestInsightsAndRecommendations:
    ...
    async def test_generate_insights_excellent_performance(self, results_analyzer):
        ...
        excellent_metrics = PerformanceMetrics(
            total_return=0.25, annualized_return=0.25, volatility=0.1, sharpe_ratio=2.5,
            sortino_ratio=3.0, max_drawdown=-0.03, calmar_ratio=8.3, profit_factor=2.5,
            win_rate=0.7, total_trades=150, avg_trade_return=0.00167, var_95=-0.015,
            skewness=0.1, kurtosis=3.0, trade_frequency=1.5
        )
        
        excellent_components = FitnessComponents(
            return_component=2.0, risk_component=1.8, consistency_component=1.5,
            trade_efficiency_component=1.3, robustness_component=1.2, penalty_component=1.0
        )
        
        insights = await results_analyzer._generate_insights(excellent_metrics, excellent_components)
        
        # Should generate positive insights
        assert len(insights) > 0
        assert any("Excellent" in insight or "High" in insight or "Strong" in insight 
    ...
    async def test_generate_warnings_poor_performance(self, results_analyzer):
        ...
        poor_metrics = PerformanceMetrics(
            total_return=-0.05, annualized_return=-0.05, volatility=0.35, sharpe_ratio=-0.14,
            sortino_ratio=-0.2, max_drawdown=-0.25, calmar_ratio=-0.2, profit_factor=0.8,
            win_rate=0.3, total_trades=25, avg_trade_return=-0.002, var_95=-0.08,
            skewness=-1.0, kurtosis=5.0, trade_frequency=0.2
        )
    ...
    async def test_generate_recommendations(self, results_analyzer):
        ...
        mediocre_metrics = PerformanceMetrics(
            total_return=0.08, annualized_return=0.08, volatility=0.15, sharpe_ratio=0.53,
            sortino_ratio=0.6, max_drawdown=-0.12, calmar_ratio=0.67, profit_factor=1.1,
            win_rate=0.45, total_trades=75, avg_trade_return=0.00107, var_95=-0.03,
            skewness=0.2, kurtosis=3.5, trade_frequency=0.8
        )
        ...
        assert any("improve" in rec.lower() or "consider" in rec.lower() 
...
class TestCompleteAnalysisWorkflow:
    ...
    async def test_analyze_experiment_results_complete(self, results_analyzer, sample_training_results, sample_backtesting_results):
    ...
    async def test_analyze_experiment_results_excellent(self, results_analyzer, sample_training_results, excellent_backtesting_results):
    ...
    async def test_analyze_experiment_results_poor(self, results_analyzer, sample_training_results, poor_backtesting_results):
    ...
    async def test_analyze_experiment_results_with_additional_data(self, results_analyzer, sample_training_results, sample_backtesting_results):
        ...
        result = await results_analyzer.analyze_experiment_results(
            experiment_id, sample_training_results, sample_backtesting_results, additional_data
        )
...
class TestStrategyComparison:
    ...
    async def test_compare_strategies_multiple_results(self, results_analyzer, sample_training_results):
        """Test comparison of multiple strategy results"""
        # Create multiple analysis results
        results = []
        
        for i, (return_val, sharpe) in enumerate([(0.15, 1.4), (0.20, 1.8), (0.10, 1.0)]):
            backtest_results = {
        ...
        assert best_strategy["total_return"] == 0.20  # Should be highest return strategy
    ...
    async def test_compare_strategies_single_result(self, results_analyzer, sample_training_results, sample_backtesting_results):
...
class TestErrorHandlingAndEdgeCases:
    ...
    async def test_missing_optional_data_fields(self, results_analyzer, sample_training_results):
...
class TestConfigurationAndCustomization:
    ...
    def test_custom_weights_configuration(self):
        ...
        total = (analyzer.return_weight + analyzer.risk_weight + 
                analyzer.consistency_weight + analyzer.efficiency_weight + 
                analyzer.robustness_weight)
    ...
    async def test_threshold_impact_on_penalties(self):
        ...
        mediocre_metrics = PerformanceMetrics(
            total_return=0.1, annualized_return=0.1, volatility=0.15, sharpe_ratio=1.0,
            sortino_ratio=1.2, max_drawdown=-0.10, calmar_ratio=1.0, profit_factor=1.2,
            win_rate=0.5, total_trades=100, avg_trade_return=0.001, var_95=-0.02,
            skewness=0.0, kurtosis=3.0, trade_frequency=1.0
        )
        
        strict_penalty = await strict_analyzer._calculate_penalty_component(mediocre_metrics)
        lenient_penalty = await lenient_analyzer._calculate_penalty_component(mediocre_metrics)
