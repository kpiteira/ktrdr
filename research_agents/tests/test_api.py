...
class TestResearchAPI:
    ...
    async def test_list_sessions_endpoint(self, async_test_client: AsyncClient):
        ...
        session_names = [f"TEST_API_ListSession_{i}_{uuid4().hex[:8]}" for i in range(3)]
    ...
    async def test_get_experiment_endpoint(self, async_test_client: AsyncClient):
        ...
        create_response = await async_test_client.post("/experiments", json=experiment_data)
    ...
    @pytest.mark.asyncio
    async def test_update_experiment_status_endpoint(self, async_test_client: AsyncClient):
        ...
        update_response = await async_test_client.patch(f"/experiments/{experiment_id}/status", json=update_data)
    ...
    async def test_complete_experiment_endpoint(self, async_test_client: AsyncClient):
        ...
        complete_response = await async_test_client.patch(f"/experiments/{experiment_id}/complete", json=completion_data)
    ...
    async def test_list_experiments_by_session(self, async_test_client: AsyncClient):
        ...
        experiment_names = [f"TEST_API_ListExperiment_{i}_{uuid4().hex[:8]}" for i in range(3)]
        ...
        list_response = await async_test_client.get(f"/sessions/{session_id}/experiments")
        assert list_response.status_code == 200
    ...
    @pytest.mark.asyncio
    async def test_create_knowledge_entry_endpoint(self, async_test_client: AsyncClient):
    ...
    async def test_get_knowledge_entry_endpoint(self, async_test_client: AsyncClient):
        ...
        create_response = await async_test_client.post("/knowledge", json=knowledge_data)
    ...
    async def test_search_knowledge_endpoint(self, async_test_client: AsyncClient):
        ...
        # Search by tags
        search_response = await async_test_client.get("/knowledge/search?tags=test_search")
    ...
    @pytest.mark.asyncio
    async def test_get_experiment_statistics_endpoint(self, async_test_client: AsyncClient):
        ...
        for i in range(3):
            ...
            if i < 2:
                ...
                await async_test_client.patch(f"/experiments/{experiment_id}/complete", json=completion_data)
        
        # Get statistics
        stats_response = await async_test_client.get(f"/sessions/{session_id}/statistics")
    ...
    async def test_api_validation(self, async_test_client: AsyncClient):
        ...
        response = await async_test_client.post("/experiments", json=invalid_experiment_data)
        assert response.status_code == 422
