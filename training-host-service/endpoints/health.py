    ...
    try:
        ...
        if gpu_manager and gpu_manager.enabled:
            try:
                ...
                gpu_manager_status = {
                    "initialized": True,
                    "monitoring_active": hasattr(gpu_manager, '_monitoring_active') and gpu_manager._monitoring_active,
            ...
            gpu_manager_status = {"initialized": False, "reason": "GPU not available or manager failed to initialize"}
